                ...
                <div class="p-6">
                  <div class="divide-y divide-gray-200 overflow-hidden rounded-lg bg-white shadow">
                    ...
                    <div class="px-4 py-5 sm:p-6">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci asperiores deserunt id quam quidem. Ab aperiam aspernatur autem debitis enim facere fuga laborum nihil officia perspiciatis provident, quam quod voluptas.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section aria-labelledby="section-2-title">
              ...
              <div class="overflow-hidden rounded-lg bg-white shadow">
                <div class="p-6">
                  <div class="overflow-hidden rounded-lg bg-white shadow">
                    <div class="px-4 py-5 sm:p-6">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius minus neque quam quod velit. Dignissimos enim, facere quam quos recusandae rem sint. Consequatur dolorum enim exercitationem hic non, rem repellat.
                    </div>
                  </div>
                </div>
              </div>
...
const navigation = [
  ...
  { name: 'Mata Kuliah', href: '#', current: false },
  { name: 'Menu Lain', href: '#', current: false },
  { name: 'Menu Lain', href: '#', current: false },
]
